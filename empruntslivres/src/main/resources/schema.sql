...
create table pret (id int primary key, isbn VARCHAR(100), lecteur int, date_pret VARCHAR(100), date_retour VARCHAR(100), foreign key (isbn) references livres(isbn), foreign key (lecteur) references lecteurs(id));
